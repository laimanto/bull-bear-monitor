...
Removing the 2/3+8-day gate entirely (pure daily threshold on the combined
confidence) was also tested and rejected: mean capture -2.4% vs keeping the
gate, and it costs NVDA specifically (-43%) - the gate stays.
